...
db <- dbscan::dbscan(bicycle_crd_2018, eps = 0.009, minPts = 3)
db
...
db <- dbscan::dbscan(bicycle_crd_2018, eps = 0.004, minPts = 3)
db
plot(bicycle_crd_2018, 
     cex = 0.5, pch = 19, col = db$cluster + 1,
...
db <- dbscan::dbscan(bicycle_crd_2018, eps = 0.002, minPts = 3)
db
plot(bicycle_crd_2018, 
     cex = 0.5, pch = 19, col = db$cluster + 1,
